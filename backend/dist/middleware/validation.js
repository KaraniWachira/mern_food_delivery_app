...
exports.validateMyUserRequest = [
    ...
    (0, express_validator_1.body)("addressLine1").isString().notEmpty().withMessage("AddressLine1 must be string"),
    (0, express_validator_1.body)("city").isString().notEmpty().withMessage("City must be a string"),
    (0, express_validator_1.body)('county').isString().notEmpty().withMessage("County must be a string"),
